...
func (*ReplicationMarkerDescriptor) Descriptor() ([]byte, []int) {
	return file_WAL_proto_rawDescGZIP(), []int{10}
}

func (x *ReplicationMarkerDescriptor) GetRegionServerName() string {
	if x != nil && x.RegionServerName != nil {
		return *x.RegionServerName
	}
	return ""
}
...
var file_WAL_proto_rawDesc = string([]byte{
	...
	,
	...
	0x41, 0x4c, 0x10, 0x02, 0x42, 0x4d, 0x0a, 0x31, 0x6f, 0x72, 0x67, 0x2e, 0x61, 0x70, 0x61, 0x63,
	...
	0x6f, 0x74, 0x6f, 0x73, 0x48, 0x01, 0x5a, 0x05, 0x2e, 0x2e, 0x2f, 0x70, 0x62, 0x88, 0x01, 0x00,
	0xa0, 0x01, 0x01,
})
...
var file_WAL_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_WAL_proto_goTypes = []any{
	...
	(*ReplicationMarkerDescriptor)(nil),          // 13: pb.ReplicationMarkerDescriptor
	(*FlushDescriptor_StoreFlushDescriptor)(nil), // 14: pb.FlushDescriptor.StoreFlushDescriptor
	(*UUID)(nil),                                 // 15: pb.UUID
	(*TableName)(nil),                            // 16: pb.TableName
	(*ServerName)(nil),                           // 17: pb.ServerName
}
var file_WAL_proto_depIdxs = []int32{
	15, // 0: pb.WALKey.cluster_id:type_name -> pb.UUID
	6,  // 1: pb.WALKey.scopes:type_name -> pb.FamilyScope
	15, // 2: pb.WALKey.cluster_ids:type_name -> pb.UUID
	...
	14, // 6: pb.FlushDescriptor.store_flushes:type_name -> pb.FlushDescriptor.StoreFlushDescriptor
	16, // 7: pb.BulkLoadDescriptor.table_name:type_name -> pb.TableName
	...
	17, // 11: pb.RegionEventDescriptor.server:type_name -> pb.ServerName
