...
var file_HFile_proto_rawDesc = string([]byte{
	...
	0x72, 0x79, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x4b, 0x65, 0x79, 0x42, 0x4f, 0x0a, 0x31, 0x6f, 0x72,
	...
	0x0b, 0x48, 0x46, 0x69, 0x6c, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x48, 0x01, 0x5a, 0x05,
	0x2e, 0x2e, 0x2f, 0x70, 0x62, 0x88, 0x01, 0x01, 0xa0, 0x01, 0x01,
})

var (
	file_HFile_proto_rawDescOnce sync.Once
	file_HFile_proto_rawDescData []byte
)

func file_HFile_proto_rawDescGZIP() []byte {
	file_HFile_proto_rawDescOnce.Do(func() {
		file_HFile_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_HFile_proto_rawDesc), len(file_HFile_proto_rawDesc)))
	})
	return file_HFile_proto_rawDescData
}

var file_HFile_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_HFile_proto_goTypes = []any{
...
func file_HFile_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_HFile_proto_rawDesc), len(file_HFile_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
