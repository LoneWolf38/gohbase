...
var file_AccessControl_proto_rawDesc = string([]byte{
	...
	0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x57, 0x0a, 0x31, 0x6f,
...
var (
	...
	file_AccessControl_proto_rawDescData []byte
)

func file_AccessControl_proto_rawDescGZIP() []byte {
	file_AccessControl_proto_rawDescOnce.Do(func() {
		file_AccessControl_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_AccessControl_proto_rawDesc), len(file_AccessControl_proto_rawDesc)))
	})
...
var file_AccessControl_proto_goTypes = []any{
...
func file_AccessControl_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_AccessControl_proto_rawDesc), len(file_AccessControl_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   19,
			NumExtensions: 0,
			NumServices:   1,
